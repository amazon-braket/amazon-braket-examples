...
We explore both aforementioned approaches of QC-AFQMC in this repo, allowing you to make a comparison and have a better understanding of the pros and cons of each method. Our implementations are primarily based on Ref.[1,4], although Ref. [5,6] signficantly reduced the classical post-processing cost of the shadow approach. The notebooks are organized as follows:
...
5. Zhao, Luning, et al. "Quantum-Classical Auxiliary Field Quantum Monte Carlo with Matchgate Shadows on Trapped Ion Quantum Computers." [Physical Review Research 8.3 (2026): 033061](https://journals.aps.org/prresearch/abstract/10.1103/n1tf-8kr7).
6. Nappi, Francesco, Matthew Kiser, and Fedor Šimkovic IV. "Quantum-Classical Auxiliary-Field Quantum Monte Carlo at the Edge of Practicability." [arXiv:2606.19239 (2026)](https://arxiv.org/abs/2606.19239).
