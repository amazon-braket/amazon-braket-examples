...
from mitiq.zne import construct_circuits, combine_results, RichardsonFactory, ExpFactory
...
dist = get_twirled_readout_dist([0,1,2,3,4,5],100, shots = 4*shot_total, device = qd_total)
...
# method = RichardsonFactory.extrapolate
...
noisy_result = np.sum(noisy_base)
print('noisy_result (w or w/o REM): ',)
print(noisy_result, '/', zne_results[0])
