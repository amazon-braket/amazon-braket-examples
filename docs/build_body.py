...
categories = {
    ...
    "braket"    : "Amazon Braket features",
    "advanced"  : "Advanced circuits and algorithms",
    "hybrid"    : "Hybrid quantum algorithms",
    "simulators": "Using simulators",
    "noise"     : "Noise on Braket",
    "jobs"      : "Amazon Braket hybrid jobs",
    "qhps"      : "Using quantum device ", 
    "pulse"     : "Pulse control",
    "ahs"       : "Analog Hamiltonian Simulation",
    "experimental-dynamic" : "Experimental Capabilities",
    "ionq"      : "IonQ",
    "iqm"       : "IQM",
    "quera"     : "QuEra",
    "rigetti"   : "Rigetti",
